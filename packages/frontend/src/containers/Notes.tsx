...
/**
 * 
 * Not deleting the old attachment when a new one is uploaded. 
 * 
 * It should be pretty straightforward. Check the AWS Amplify 
 * API Docs on how to a delete file from S3.
 */
